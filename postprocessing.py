...
from utils.residual_functions import compute_residuals_Q
...
def refinement_with_inliers(opt, X, inliers):
    ...
    residuals = compute_residuals_Q(opt, X, models)

    inlier_fun = inlier_functions[opt.inlier_function](opt.inlier_softness, opt.inlier_threshold)

    inlier_scores = inlier_fun(residuals,opt.inlier_softness)
